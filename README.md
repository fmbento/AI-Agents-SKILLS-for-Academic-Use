...
The skills are intentionally complementary: use `tradutor-feynman` or `eli14` to explain, `arquiteto-mermaid` to visualise, `simulador-pbl` to practise, and `scopus-research` to investigate academic literature.
